...
# Что такое Sheezy_assistantBot и какую пользу может принести бот для пользователей?
...
```
 ...
 __Так например при новом чате вас будет встречать окно, где написано что умеет бот и какую пользу это приносит__
